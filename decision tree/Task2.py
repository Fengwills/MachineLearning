...
# classify(my_decision_tree, test_sample)
...
# YOUR CODE HERE
# my_decision_tree = decision_tree_create(train_data,one_hot_features,target,'information_gain',current_depth=0,max_depth=6,annotate=False)
# predictions = predict(my_decision_tree,test_data)
# # predictions = cross_val_predict(my_decision_tree,loans[features],loans[target],cv=10)
